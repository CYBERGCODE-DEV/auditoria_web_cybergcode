...
export const REMEDIATIONS = Object.freeze({
  ...
  'INFRA-DOMAIN-001': remediation(
    'Verificar inmediatamente el estado del dominio con el registrador y renovarlo o restaurarlo si corresponde.',
    'El registro debe permanecer activo y con renovación controlada para evitar pérdida de DNS, correo y disponibilidad.',
    ['Acceder al registrador autorizado.', 'Confirmar estado EPP y fecha contractual.', 'Renovar o restaurar el dominio.', 'Validar nameservers y activar renovación/alertas.'],
    'RDAP y el panel del registrador muestran una fecha futura coherente y el dominio resuelve normalmente.', null, 'Alta'
  ),
  'INFRA-DOMAIN-002': remediation(
    'Renovar el dominio antes de la fecha publicada y configurar alertas y renovación automática controlada.',
    'Debe existir margen operativo suficiente y un medio de pago/contacto vigente en el registrador.',
    ['Confirmar la fecha en el registrador.', 'Revisar contactos y pago.', 'Renovar con anticipación.', 'Configurar alertas 60/30/15/7 días.'],
    'El registro muestra un margen aceptable según la política operativa y existe evidencia de alertas/renovación.', null, 'Baja'
  ),
