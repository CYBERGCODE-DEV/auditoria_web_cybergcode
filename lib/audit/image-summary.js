...
export function buildImageSummary(pages = [], inspection = {}, browserData = null) {
  ...
  return {
    status: (inspection.totalUnique || assets.length) > (inspection.inspected || 0) ? 'partial' : 'measured',
    inspectionCoverage: { inspected: inspection.inspected || 0, totalUnique: inspection.totalUnique || assets.length, complete: (inspection.totalUnique || assets.length) <= (inspection.inspected || 0) },
